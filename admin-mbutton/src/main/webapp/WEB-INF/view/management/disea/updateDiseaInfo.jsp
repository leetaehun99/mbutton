...
$(function() {
	...
	$("#updateDisea").click(function(){ // 약품 수정
		$("#diseaForm").attr("action", "/disea/updateDisea.json");
		$("#diseaForm").ajaxSubmit(updateDiseaAjax);
	});
...
<form id="diseaForm" name="diseaForm" action="/disea/updateDisea.doo" method="post" >
