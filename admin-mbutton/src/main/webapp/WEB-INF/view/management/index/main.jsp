...
<div id="memberContener" style="display:none;cursor:default;">
	<form id="userForm" name="userForm" action="/user/selectUserList.doo"method="post">
		...
		<div style="padding: 20px; background: #f8f8f8; height: 440px;">
			<table class="table7 table7_main" style="border-left: 1px solid #b5b5b5;border-bottom: 1px solid #b5b5b5;">
				<tbody>
					...
					<tr>
						...
						<td style="text-align:left;padding-left:10px;padding-top:5px;padding-bottom:5px;" colspan="2"><input type="text" id="licenNum" name="licenNum" value="" size="20"  maxlength="5" height="28px" /></td>
					</tr>
					<tr>
						<th style="text-align:left; padding-left:30px;">병원주소</th>
						<td style="text-align:left;padding-left:10px;padding-top:5px;padding-bottom:5px;" colspan="2"><input type="text" id="zip1" value="" size="3"  maxlength="3" height="28px" />-<input type="text" id="zip2" value="" size="3"  maxlength="3"/>&nbsp;&nbsp;<input type="text" id="addr" name="addr" value="" size="20"  maxlength="50" height="28px" /></td>
					</tr>
					<tr>
						...
						<td style="text-align:left;padding-left:10px;padding-top:5px;padding-bottom:5px;" colspan="2">
							...
							<input type="text" id="phone2" value="" size="4"  height="28px"  maxlength="4"/>-<input type="text" id="phone3" value="" size="4" height="28px" maxlength="4"/></td>
					</tr>
					<tr>
						<th style="text-align:left; padding-left:30px;">이메일</th>
						<td style="text-align:left;padding-left:10px;padding-top:5px;padding-bottom:5px;" colspan="2">
							<input type="text" id="email1" value="" size="20" height="28px" maxlength="8"/>@
