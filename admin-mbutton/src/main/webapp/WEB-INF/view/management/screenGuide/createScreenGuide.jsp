...
<script type="text/javascript">
	$(function() {
		$("#createScreenGuide").click(function(){ //게시판 등록
			oEditors2.getById["content"].exec("UPDATE_CONTENTS_FIELD", []);
				$("#ScreenGuideForm").attr("action", "/screenGuide/createScreenGuide.doo");
...
<form id="ScreenGuideForm" name="ScreenGuideForm" action="/screenGuide/selectScreenGuideList.doo" method="post" enctype="multipart/form-data">
	...
	<table class="table9">
		...
		<tfoot>
			<tr>
				<td colspan="8">
				<span class="button medium icon"><span class="check"></span><a id="createScreenGuide">등록</a></span>
