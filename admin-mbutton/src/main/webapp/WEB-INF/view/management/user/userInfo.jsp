...
var idDuplicat=false; // ID 중복체크
	$(function() {
		$("#updateUser").click(function(){ //사용자 등록 폼 이동
			if(validationCheck()){
				$("#userForm").attr("action", "/user/updateUser.json");
				$("#userForm").ajaxSubmit( userCheckAjax );
			}
		});
	});
		...
		<tfoot>
			<tr>
				<td colspan="2" style="text-align:right; vertical-align: middle; padding-right:10px;">
					<span class="button medium icon"><span class="check"></span><a id="updateUser">등록</a></span>
				</td>
			</tr>
		</tfoot>
	</table>
