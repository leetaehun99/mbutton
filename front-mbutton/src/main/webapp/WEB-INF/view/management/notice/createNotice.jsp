...
<script type="text/javascript">
	$(function() {
		$("#createNotice").click(function(){ //게시판 등록
			oEditors2.getById["content"].exec("UPDATE_CONTENTS_FIELD", []);
				$("#noticeForm").attr("action", "/notice/createNotice.doo");
				$("#noticeForm").submit();
		});
...
<form id="noticeForm" name="noticeForm" action="/notice/selectNoticeList.doo" method="post" enctype="multipart/form-data">
	...
	<table class="table9">
		...
		<tfoot>
			<tr>
				<td colspan="8">
				<span class="button medium icon"><span class="check"></span><a id="createNotice">등록</a></span>
