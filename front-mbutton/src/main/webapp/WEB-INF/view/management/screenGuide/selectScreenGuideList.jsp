			...
			<c:if test="${noticeList != null}">
				<c:forEach var="notice" items="${noticeList}">
					<tr >
						...
						<td style="text-align:left;padding-left:10px;" class="trFocus" onclick="javascript:readNoticeScreenGuide('${notice.noticeSeq}');"><span class="dot500">${notice.subject}</span></td>
						<td>${notice.userNm}</td>
